...
static const char WHATS_NEW_TEXT_04[] = "| Cardiff Giant  |\n";
static const char WHATS_NEW_TEXT_05[] = "| logo splash on |\n";
static const char WHATS_NEW_TEXT_06[] = "| watchface      |\n";
static const char WHATS_NEW_TEXT_07[] = "| load ... get   |\n";
static const char WHATS_NEW_TEXT_08[] = "| ready for it!  |\n";
...
#define GIANT_SPLASH RESOURCE_ID_GIANT_SPLASH_BASALT
#else
#define FOREGROUND_COLOR GColorWhite
#define GIANT_SPLASH RESOURCE_ID_GIANT_SPLASH_APLITE
#endif
...
static BitmapLayer *s_giant_splash_layer;
static GBitmap *s_giant_splash_bitmap;
...
static void splash_timer_callback(void *data) {
  ...
  layer_set_hidden((Layer *)s_giant_splash_layer, true);
}
...
static void main_window_load(Window *window) {
  ...
  s_giant_splash_bitmap = gbitmap_create_with_resource(GIANT_SPLASH);
  s_giant_splash_layer = bitmap_layer_create(GRect(0, 0, 144, 168));
  bitmap_layer_set_bitmap(s_giant_splash_layer, s_giant_splash_bitmap);
  layer_add_child(window_get_root_layer(window), bitmap_layer_get_layer(s_giant_splash_layer));
...
static void main_window_unload(Window *window) {
  ...
  // Destroy GBitmap
  gbitmap_destroy(s_giant_splash_bitmap);

  // Destroy BitmapLayer
  bitmap_layer_destroy(s_giant_splash_layer);
}
